var checkTypes = require('check-types'), _ = require('underscore'), logger = require('./logger'), path = require('path'), fs = require('fs'), cp = require('child_process'), q = require('q'), unixify = require('unixify'), url = require('url'), verifierPath = require('@pact-foundation/pact-provider-verifier'), pactUtil = require('./pact-util'), isWindows = process.platform === 'win32';
